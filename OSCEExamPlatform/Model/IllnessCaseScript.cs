...
namespace Tellyes.Model
{
    public class IllnessCaseScript
    {
        ...
        /// 病例脚本信息名称
        /// </summary>		
        private string _illnesscasescriptname;
        public virtual string IllnessCaseScriptName
        {
            get { return _illnesscasescriptname; }
            set { _illnesscasescriptname = value; }
        }
        /// <summary>
        /// 病例脚本所属病例ID
        /// </summary>		
        ...
        /// 病例脚本描述内容（HTML格式）
        /// </summary>		
        private string _illnesscasescriptcontent;
        public virtual string IllnessCaseScriptContent
        {
            get { return _illnesscasescriptcontent; }
            set { _illnesscasescriptcontent = value; }
        }
        /// <summary>
        /// 病例脚本描述内容（文本格式）
        /// </summary>		
        private string _illnesscasescripttext;
        public virtual string IllnessCaseScriptText
        {
            get { return _illnesscasescripttext; }
            set { _illnesscasescripttext = value; }
        }
        /// <summary>
        /// 创建者用户ID
        /// </summary>		
        ...
        public virtual string ToJsonString()
        {
            return new StringBuilder()
                .Append("{")
                .Append("\"IllnessCaseScriptID\":\"" + this.IllnessCaseScriptID + "\",")
                .Append("\"IllnessCaseScriptName\":\"" + Uri.EscapeDataString(this.IllnessCaseScriptName) + "\",")
                .Append("\"IllnessCaseID\":\"" + this.IllnessCaseID + "\",")
                .Append("\"IllnessCaseScriptContent\":\"" + Uri.EscapeDataString(this.IllnessCaseScriptContent) + "\",")
                .Append("\"IllnessCaseScriptText\":\"" + Uri.EscapeDataString(this.IllnessCaseScriptText) + "\",")
