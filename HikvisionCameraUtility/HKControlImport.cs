...
namespace com.tellyes.DeviceControl.HKSControl
{
    ...
    public delegate void RealDataCallBack1(int lRealHandle, uint dwDataType, [MarshalAs(UnmanagedType.LPArray, SizeConst = 11520)] byte[] pBuffer, uint dwBufSize, uint dwUser);
    ...
    public sealed class Hik_HCNetSDK
    {
        ...
        public const int UP_LEFT = 25;//云台上仰和左转 
        public const int UP_RIGHT = 26;// 云台上仰和右转
        public const int DOWN_LEFT = 27;//云台下俯和左转 
        public const int DOWN_RIGHT = 28;// 云台下俯和右转
        ...
        [DllImport("HCNetSDK.dll")]
        public static extern bool NET_DVR_GetDVRIPByResolveSvr(string sServerIP, ushort wServerPort, string sDVRName, ushort wDVRNameLen, string sDVRSerialNumber, ushort wDVRSerialLen, ref string sGetIP);
        //图像预览
        [DllImport("HCNetSDK.dll")]
        ...
        [DllImport("HCNetSDK.dll")]
        public static extern bool NET_DVR_SetRealDataCallBack(int lRealHandle, RealDataCallBack1 x, uint dwUser);
        //抓图
        [DllImport("HCNetSDK.dll")]
        ...
        **********************************************************/
        ...
        //public delegate void VOICEDATACALLBACK(int lVoiceComHandle, string pRecvDataBuffer, uint dwBufSize, byte byAudioFlag, System.IntPtr pUser);
        //语音对讲
        [DllImport("HCNetSDK.dll")]
